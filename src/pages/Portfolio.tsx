    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="max-w-6xl mx-auto px-6 pt-20 pb-24 md:pt-32 md:pb-32 relative">
          <div className="grid md:grid-cols-[1.4fr_1fr] gap-12 items-center">
            ...
            >
              ...
              <div className="relative w-64 h-80 md:w-80 md:h-[26rem] rounded-[2rem] overflow-hidden border-4 border-card shadow-2xl bg-gradient-to-br from-primary/20 via-muted to-card">
                <motion.img
                  key={theme}
                  src={theme === "dark" ? ianPhotoDark : ianPhoto}
                  alt="Ian Baterna"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
      ...
      <section id="contact" className="relative overflow-hidden py-24 border-t border-border bg-foreground text-background">
        <div className="absolute inset-0 pointer-events-none hidden dark:block">
          <div className="absolute -top-32 -left-32 w-[480px] h-[480px] rounded-full bg-primary/8 blur-3xl" />
          <div className="absolute -bottom-40 -right-32 w-[520px] h-[520px] rounded-full bg-primary/5 blur-3xl" />
        </div>
